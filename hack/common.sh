...
readonly OS_GO_PACKAGE=github.com/openshift/kube-projects
...
function os::build::etcd_version_vars() {
  ETCD_GIT_VERSION="DELETE_ME"
  ETCD_GIT_COMMIT="DELETE_ME"
}
...
function os::build::kube_version_vars() {
  KUBE_GIT_VERSION="DELETE_ME"
  KUBE_GIT_COMMIT="DELETE_ME"
